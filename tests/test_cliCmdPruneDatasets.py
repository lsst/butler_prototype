...
class PruneDatasetsTestCase(unittest.TestCase):
    ...
    def test_defaults_doContinue(self):
        ...
        self.run_test(cliArgs=["myCollection"],
    ...
    def test_dryRun(self):
        ...
        self.run_test(cliArgs=["myCollection", "--dry-run"],
                      exPruneDatasetsCallArgs=None,
                      exQueryDatasetsCallArgs=self.makeQueryDatasetsArgs(repo=self.repo,
                                                                         collections=("myCollection",)),
                      exGetTablesCalled=True,
    ...
    def test_noConfirm(self):
        ...
        passed for removal."""
        self.run_test(cliArgs=["myCollection", "--no-confirm"],
                      exPruneDatasetsCallArgs=self.makePruneDatasetsArgs(refs=getDatasets()),
                      exQueryDatasetsCallArgs=self.makeQueryDatasetsArgs(repo=self.repo,
                                                                         collections=("myCollection",)),
                      exGetTablesCalled=True,
    ...
    def test_quiet(self):
        ...
        self.run_test(cliArgs=["myCollection", "--quiet"],
                      exPruneDatasetsCallArgs=self.makePruneDatasetsArgs(refs=getDatasets()),
                      exQueryDatasetsCallArgs=self.makeQueryDatasetsArgs(repo=self.repo,
                                                                         collections=("myCollection",)),
                      exGetTablesCalled=True,
